...
def tests():
    ...
    import os.path
    for data in (
        json.load(open(os.path.abspath("data/New World/advancements/" # Switched to using absolute path to avoid directory not found error
                       "8b4accb8-d952-4050-97f2-e00c4423ba92.json"))),
        nbt.load_dat(os.path.abspath("data/New World/level.dat")),
